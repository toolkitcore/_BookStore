...
namespace BookStore.Identity.Pages.ExternalLogin;
...
public class Callback : PageModel
{
        ...
        IEnumerable<Claim> claims)
    {
        ...
        else
        {
            ...
            else if (last != null) filtered.Add(new(JwtClaimTypes.Name, last));
        }
        ...
        AuthenticationProperties localSignInProps)
    {
        ...
        if (sid != null) localClaims.Add(new(JwtClaimTypes.SessionId, sid.Value));
